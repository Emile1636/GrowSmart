...
class Application(CTk): # Class principale 
    def __init__(self):
        ...
        # self.attributes('-fullscreen', True) # Méthode principal
        self.geometry(f"{self.winfo_screenwidth()}x{self.winfo_screenheight()}+{-100}") # Méthode secondaire, ajuster la fenêtre
