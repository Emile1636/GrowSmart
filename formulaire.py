...
class Formulaire:
    ...
    def afficher_formulaire(self):
        ...
        self.entry_username = ctk.CTkEntry(self.main_frame, placeholder_text="Nom d'utilisateur", font=("Helvetica", 18), width=350, height=50, corner_radius=15, fg_color=self.placeholder_text_color, text_color="#000000", border_width=1, border_color="#000000")
        self.entry_username.grid(row=2, column=0, columnspan=2, pady=(10, 10))
        self.entry_password = ctk.CTkEntry(self.main_frame, placeholder_text="Mot de passe", show="*", font=("Helvetica", 18), width=350, height=50, corner_radius=15, fg_color=self.placeholder_text_color, text_color="#000000", border_width=1, border_color="#000000")
    ...
    def afficher_formulaire_inscription(self):
        ...
        self.entry_new_username = ctk.CTkEntry(self.main_frame, placeholder_text="Nom d'utilisateur", font=("Helvetica", 18), width=350, height=50, corner_radius=15, fg_color="#ffffff", text_color="#000000", border_width=1, border_color="#000000")
        self.entry_new_username.grid(row=1, column=0, columnspan=2, pady=(10, 10))

        self.entry_new_password = ctk.CTkEntry(self.main_frame, placeholder_text="Mot de passe", show="*", font=("Helvetica", 18), width=350, height=50, corner_radius=15, fg_color="#ffffff", text_color="#000000", border_width=1, border_color="#000000")
        self.entry_new_password.grid(row=2, column=0, columnspan=2, pady=(10, 10))

        self.entry_confirm_password = ctk.CTkEntry(self.main_frame, placeholder_text="Confirmer le mot de passe", show="*", font=("Helvetica", 18), width=350, height=50, corner_radius=15, fg_color="#ffffff", text_color="#000000", border_width=1, border_color="#000000")
    ...
    def afficher_connexion_reussi(self):
            ...
            self.label_connexion_reussi.grid(row=0, column=0, columnspan=2, pady=(50, 20))
